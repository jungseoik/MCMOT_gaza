...
| 이름 | 저장 | 내용 |
|------|------|------|
| `v7` | 2026-08-20 | **★ 현재 디폴트([Reset] 대상)** — 16F 출입구 **2곳 모두** 카메라 화면 '영역' 게이트: 출구1 cam06 · 출구2 cam07(각 4점 · dwell 2). 층 3개 · 카메라 12대 |
| `v6` | 2026-08-20 | — 현장 매핑 최신 상태. v5에서 **16F 출구1에 카메라 화면 '영역' 게이트**(cam06 · 4점 · dwell 2)가 추가됐다(문이 화각 가장자리라 통과선으로 안 잡히던 건). 층 3개(17F 3채널 + 16F 현장 6채널 + 지상1층 3채널 미매핑), 카메라 12대. 저장 시점 라이브에 있던 실험용 `가상층`은 제외 |
| `v5` | 2026-08-20 | — 화면 통과선 기능 도입 시점. ROI 전부 없음(대응점 헐 자동), cam06 재매핑(5쌍). 17F 3채널 + 16F CAD·구역9·병목4·출입구2·경로8 + 현장 6채널 매핑 |
| `v4` | 2026-08-19 | — 16F 완성: CAD(2000×1887) + 구역 9 · 병목 4(ρcrit 2.0) · 출입구 2 · 경로 8(자동 5 + 수동 r1~r3), 현장 6채널 매핑. 17F 는 시드 도면 + 3채널 매핑 |

...
| 이름 | 저장 | 내용 |
|------|------|------|
| `v6` | 2026-08-20 | **★ 현재 디폴트([Reset] 대상)** — 현장 매핑 최신 상태. v5에서 **16F 출구1에 카메라 화면 '영역' 게이트**(cam06 · 4점 · dwell 2)가 추가됐다(문이 화각 가장자리라 통과선으로 안 잡히던 건). 층 3개(17F 3채널 + 16F 현장 6채널 + 지상1층 3채널 미매핑), 카메라 12대. 저장 시점 라이브에 있던 실험용 `가상층`은 제외 |

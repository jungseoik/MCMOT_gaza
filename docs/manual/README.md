...
| 버전 | 일자 | 쪽수 | 범위 | 산출물 |
|------|------|------|------|--------|
| [v0.0.6](v0.0.6/) | 2026-08-28 | A4 53쪽 | **최신 배포본.** v0.0.5 내용 + 운영 뷰 **[표시] 레이어 토글**(구역·경로·병목·출입구·경보원 개별 on/off — 지표 무영향)·**리허설(파일 모드)** 절 신설. 전체 화면 재캡처 | PDF·DOCX (HF `manual/v0.0.6/` — `fetch_assets.sh --manual`) |

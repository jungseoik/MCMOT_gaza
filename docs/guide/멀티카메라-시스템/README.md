...
상태(디폴트 사이트 `default`, 17F 평면도)입니다.
...
| 영역 | 내용 |
|------|------|
| 상단 탭 | ① 맵 설정 / ② 카메라 등록·매핑 / ③ 운영 뷰 전환 (우측에 `site: default · v34` 버전 표시) |
...
- 디폴트: cam01~03(1_v1/2_v1/3_v1) 매핑 완료·활성 5fps, **cam04(sample1)는 비활성·매핑 필요**

...
(ADR 09 §11). 5절의 송출 서버가 없어도 시연된다. 사이트 seed 는 **v17**(건물 개념 + 출구 카운팅 GT 14/14 세팅)로:
```bash
python tools/seed_version.py restore v17 --apply   # 건물(CJ제일제당센터·AI-hub) + 17F·16F·1F + 10F + AI hub 1·3층
```
